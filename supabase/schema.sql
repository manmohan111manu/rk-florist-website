...
insert into products (id, name, category, price, description, image, tags, bestseller) values
  ('classic-rose-bouquet', 'Red Rose Bouquet', 'Bouquets', 499, 'A rich red rose bouquet in a classic wrap, ideal for celebrations, anniversaries, and heartfelt gifting.', '/images/products/red-rose-bouquet.jpg', array['Red Roses','Classic','Anniversary'], true),
  ('sunshine-mix', 'Yellow Flower Bouquet', 'Bouquets', 399, 'A cheerful yellow floral bouquet that brings warmth and brightness to any occasion.', '/images/products/yellow-flower-bouquet.jpg', array['Yellow Flowers','Bright','Cheerful'], false),
  ('pink-peony-blush', 'Pink Rose Bouquet', 'Bouquets', 799, 'A soft pink rose arrangement with a romantic, elegant look for gifting and special moments.', '/images/products/pink-rose-bouquet.jpg', array['Pink Roses','Romantic','Elegant'], true),
  ('white-lily-elegance', 'White Flower Bouquet', 'Bouquets', 599, 'An airy white blossom bouquet that feels fresh, graceful, and perfect for elegant decor.', '/images/products/white-flower-bouquet.jpg', array['White Flowers','Fresh','Elegant'], false),
  ('lavender-dreams', 'Purple Flower Bouquet', 'Bouquets', 649, 'A purple floral bouquet with a soft, graceful palette suited for thoughtful celebrations.', '/images/products/purple-flower-bouquet.jpg', array['Purple Flowers','Soft','Celebration'], false),
  ('tropical-paradise', 'Mixed Flower Bouquet', 'Bouquets', 899, 'A colorful mixed flower bouquet with vibrant tones and a full, celebratory look.', '/images/products/mixed-flower-bouquet.jpg', array['Mixed Flowers','Colorful','Festive'], false),
